  ...
  public static String parse(String i, DamageUtil damageUtil, Player player, boolean doMath) {
    ...
    if (player != null) {
      ...
      if (damageUtil != null) {
        ...
        if (i.contains("%player.")) {
          ...
          i = fastReplace(i, "%player.pdmg100%", df.format(damageUtil.getPercentageDamage(player) * 100.0D).replace(",", ".").replace(".0", ""));
    ...
    if (damageUtil != null) {
      ...
      if (damageUtil.lastHit != null && i.contains("%lasthit")) {
        ...
        i = fastReplace(i, "%lasthit.pdmg100%", String.valueOf(df.format(damageUtil.getPercentageDamage(damageUtil.getLasthit()) * 100.0D)).replace(",", ".").replace(".0", ""));
